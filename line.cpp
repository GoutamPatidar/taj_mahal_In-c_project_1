...
/*	initwindow(750,750);
line(0,700,750,700);
line(300,700,300,625);
line(301,700,301,625);
line(370,700,370,625);
line(371,700,371,625);
arc(336,626,0,180,36);
arc(336,626,0,180,35);
//---------------------------------

line(275,700,275,553);
line(274,700,274,553);
line(400,700,400,553);
line(401,700,401,553 );
line(274,553,401,553);
line(274,553,401,553);

//----------------------------------

line(275-10,700,275-10,550-8);
line(274-10,700,274-10,550-8);
line(400+10,700,400+10,550-8);
line(401+10,700,401+10,550-8);
//line(274-10,550-8,401+10,550-8);
//line(274-10,550-7,401+10,550-7);

//----------------------------------
rectangle(264,536,411,543);
rectangle(264,535,411,542);

//----------------------------------
line(275-10,536,275-10,530);
line(274-10,536,274-10,530);
line(400+10,536,400+10,530);
line(401+10,536,401+10,530 );
ellipse(337.5,531,0,180,72.5,10);
ellipse(337.5,531,0,180,71.5,9);

//---------------------------------- 
ellipse(338.5,531,0,180,75,90);
ellipse(338.5,531,0,180,74,89);

//-----------------------------------

line(270+11,475-5,338.5,422);
line(270+12,475-6,339.5,423);
line(394,475-5,338.5,422);
line(394-1,475-5,339.5,422);
circle(338.5+1,422-5,5);
circle(338.5+1,422-5,6);
line(338.5,412,338.5,400);
line(338,412,338 ,400);
delay(50);
		getch();
}*/
{ initwindow(750,750);
...
setfillstyle(1,15);
floodfill(540,65,15);
//outtextxy(460,460,"Made By:PATIDAR_G_");
}
